...
| `URLSHORTX_API_TOKEN_2`| (Optional) API token for the secondary shortener used for limit extensions.                               | `second_api_token`                 |
| `SHORTERNER_URL_2`    | (Optional) Base domain for the secondary shortener.                                                        | `another-shortener.com`            |
